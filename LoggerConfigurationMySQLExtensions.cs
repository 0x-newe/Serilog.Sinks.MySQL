...
namespace Serilog
{
    ...
    public static class LoggerConfigurationMySqlExtensions
    {
        ...
        /// <param name="tableName">the name of the deleted table</param>
        /// <param name="recordsExpiration">Expired record TimeSpan</param>
        /// <param name="cleanupFrequency">Record cleaning frequency</param>
        /// <param name="columnNameWithTime">the name of the time field in the table</param>
        /// <param name="deleteLimit">How many to delete at once</param>
        ...
        public static LoggerConfiguration MySQL(
            ...
            TimeSpan? recordsExpiration, TimeSpan? cleanupFrequency, string columnNameWithTime = "Timestamp", int deleteLimit = 100,
            ...
            LoggingLevelSwitch levelSwitch = null)
        {
            ...
            try
            {
                return loggerConfiguration.Sink(
                    new MySqlSink(connectionString, recordsExpiration, cleanupFrequency, columnNameWithTime, deleteLimit, tableName, batchSize, storeTimestampInUtc),
